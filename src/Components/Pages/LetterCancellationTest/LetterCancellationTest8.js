...
const LetterCancellationTest8 = () => {
    ...
    useEffect(() => {
        ...
        const targetCount = 8; //liczba szukanych liter
    ...
    const saveScore = (score, userEmail, time) => {
        ...
        const scoreTest = collection(firestore, 'LetterCancel8Score'); //zdefiniowanie kolekcji wyników
...
export default LetterCancellationTest8;
