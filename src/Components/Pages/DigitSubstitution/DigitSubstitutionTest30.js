...
const totalSymbols = 30; //ilość symboli w sekwencji
/**
 * Komponent obsługujący test digit symbol substitution
 * @returns {JSX.Element}
 * @constructor
 */
const DigitSubstitutionTest30 = () => {
    ...
    const saveScore = (time, email) => {
        ...
        const scoreTest = collection(firestore,'DigitalSub30'); //definicja kolekcji
...
export default DigitSubstitutionTest30;
