...
const totalSymbols = 10; //ilość symboli w sekwencji
/**
 * Komponent obsługujący test digit symbol substitution
 * @returns {JSX.Element}
 * @constructor
 */
const DigitSubstitutionTest10 = () => {
    ...
    const saveScore = (time, email) => {
        ...
        const scoreTest = collection(firestore,'DigitalSub10'); //definicja kolekcji
...
export default DigitSubstitutionTest10;
