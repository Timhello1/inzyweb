...
const SternbergMemoryScan = () => {
    const items = ['A', 'B', 'C', 'D', 'E', 'F', 'G','H','I','J','K','L','M','N','O','P','Q','R']; //zebranie liter występujących w tescie
    ...
    const generateRandomSequence = () => {
        ...
        while (uniqueRandomIndexes.length < 6) { //wykonywana aż nie uzbiera 6 indeksów
    ...
    const savescore = () => {
        ...
        if(user){ //jeśli użytkownik jest zalogowany
            ...
            const scoreTest = collection(firestore, 'MemoryScan6'); //nazwa kolekcji
